MODULE  COMMON_MODULE 
        ...
        parameter(maxnodes_ = 61600, maxedges_ = 120000, maxfaces_ = 120000, &
		          maxboundaryedges_ = 10000,maxboundarypoints_=5000,maxnodefaces_=10,maxelements_=1000000)
...
!       3. faces (edge IDs, point IDs, only triangle for now)
        ...
        integer*4 nElementType(maxelements_)
...
!       edge length
		...
		character*50::meshfilename
		character*50::demfilename
		integer*4:: meshfiletype
